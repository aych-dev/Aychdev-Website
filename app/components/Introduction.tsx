      ...
      <div className='max-w-2xl'>
        <div className='border border-white '>
          ...
          <p className='m-4 '>
            ...
            blockchain and web/app development. It was not until I got older
            that I grew a huge interest in coding/development so I hope my story
            inspires anyone to go for it. I love that my work feels meaningful
            and I really enjoy helping up-and-coming aspiring developers. More
            than anything, I want my story to inspire people to believe in their
