...
const Projects = (): JSX.Element => {
      ...
      <div key={index} className='p-3 items-center justify-center'>
        ...
        >
          ...
          <div className='mt-4 px-2'>
            ...
            <p className='mt-2 md:text-sm sm:text-xs'>{project.description}</p>
          </div>
  ...
  return (
    <div className=' text-white md:grid grid-cols-4 items-center justify-center min-w-full flex-grow'>
      {projectElement}
    </div>
  );
};
